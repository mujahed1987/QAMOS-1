<?php
	...
	if(isset($_POST["submit"]) && isset($_POST["user"]) && isset($_POST["pass"])){
		$error = ""; $ok = 0;
		$user = $con->real_escape_string(htmlspecialchars(stripslashes(strip_tags($_POST["user"]))));
		$pass = md5($con->real_escape_string(htmlspecialchars(stripslashes(strip_tags($_POST["pass"])))));
