...
if(isset($_POST["wadd"]) && isset($_POST["weng"]) && isset($_POST["war"])){
	...
	$weng = $con->real_escape_string(htmlspecialchars(stripslashes(strip_tags($_POST['weng']))));;
	$war = $con->real_escape_string(htmlspecialchars(stripslashes(strip_tags($_POST['war']))));;
	
	if(isset($_POST["wex"])){
		$wex = $con->real_escape_string(htmlspecialchars(stripslashes(strip_tags($_POST['wex']))));
	}else{
		$wex = "0";
	}if(isset($_POST["wcom"])){
		$comm = $con->real_escape_string(htmlspecialchars(stripslashes(strip_tags($_POST['wcom']))));
	}else{
		$comm = "0";
	}
	$id = $_SESSION["userid"];
