 ...
 <div class="table-responsive" dir="rtl">          
  <table class="table table-bordered table-striped">
	...
	<?php	
			...
			$res = $con->query($sql);
			$verz = '<img src="clock.png" width="16" height="16" alt="انتظار التأكيد" title="فى انتظار التأكد">';
			$vero = '<img src="accept.png" width="16" height="16" alt="تم التأكد" title="تم التأكد">';
			if($res->num_rows > 0){
